...
Jami **525 ta dars** tayyor va test qilingan, o'nta bosqichga bo'lingan holda (menyuda ko'rsatiladigan tartib bo'yicha). Kurs dasturi asl texnik topshiriqdagi (`go_zero_to_hero_claude_code_prompt.md`) LEVEL 1–8 ro'yxatiga to'g'ridan-to'g'ri mos qilib tuzilgan:
...
To'liq oqim (menyu → theory → task → Vim → test → hint → progress → next lesson) barcha 525 ta dars uchun ishlaydi. Yangi dars qo'shish yuqoridagi "How to add a new lesson" bo'yicha bosqichma-bosqich amalga oshiriladi.
