# Diagonal qismlarning yig'indisi
...
N×N kvadrat matritsa berilgan. Asosiy va qo'shimcha diagonallarning yig'indisini toping (kesishma 1 marta).

Quyidagi funksiyani to'ldiring:

```go
func diagonalPartSums(N int, matrix [][]int) int {
    // ...
}
```
