# K dan katta elementlar ichida minimum
...
N ta son va K berilgan. K dan katta elementlar ichidan eng kichigini toping. Bo'lmasa 0.

Quyidagi funksiyani to'ldiring:

```go
func minGreaterThanK(N int, K int, nums []int) int {
    // ...
}
```
