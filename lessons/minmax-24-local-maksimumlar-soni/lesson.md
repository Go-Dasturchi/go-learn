...
```
Input: N=7, nums=[5, 2, 8, 1, 9, 3, 7]
Output: 3
```

## TASK

N ta son berilgan. Local maksimum (qo'shnilaridan katta) larning sonini toping.

Quyidagi funksiyani to'ldiring:

```go
func localMaxCount(N int, nums []int) int {
    // ...
}
```
